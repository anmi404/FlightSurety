...
contract FlightSuretyApp {
    ...
    uint8 private constant STATUS_CODE_LATE_AIRLINE = 20; // Payment Event should be triggered
    ...
    */
    ...
    function isOperational() 
                            ...
                            returns(bool) 
    {
        return flightSuretyData.isOperational();  // Modified to call data contract's status
    }
